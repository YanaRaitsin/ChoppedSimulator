...
public class Matrix4f extends Matrix implements Serializable {
	 ...
	 * @return this
	 */
	public Matrix4f translate(Vector2 vec) {
	 ...
	 * @return the translated matrix
	 */
	public Matrix4f translate(Vector2 vec, Matrix4f dest) {
		return translate(vec, this, dest);
	}
	 ...
	 * @return The translated matrix
	 */
	public static Matrix4f translate(Vector2 vec, Matrix4f src, Matrix4f dest) {
		if (dest == null)
			dest = new Matrix4f();
