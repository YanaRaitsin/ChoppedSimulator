...
public class Window {
    ...
    public void init() {
        ...
        // Create the window
        windowHandle = glfwCreateWindow(width, height, title, fullScreen ? glfwGetPrimaryMonitor() : 0, NULL);
        ...
        ByteBuffer bufferedImage = ImageLoader.loadImageToByteBuffer("src/main/java/resources/main/choppedlogo.png");
